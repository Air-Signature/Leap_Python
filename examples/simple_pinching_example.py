...
of the middle is calculated and we check it against a threshold of 20 in each 
axis. If any one axis is off by more than 20, we say the finger and middle are 
not pinching.
"""
